...
primary key(cno));
	...
	//전부다
	public CommentVO(int cno, int bno, String writer, String content, String regdate, String datetime) {
		super();
		this.cno = cno;
		this.bno = bno;
		this.writer = writer;
	...
	public String toString() {
		return "CommentVO [cno=" + cno + ", bno=" + bno + ", writer=" + writer + ", content=" + content + ", regdatd="
